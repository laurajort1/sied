...
<div class="container">
  ...
  foreach ($ambientes as $ambiente) {
    ...
    <tr>
      <!-- contenido -->
      <td><?php echo $ambiente->getNombre(); ?></td>
      <?php $cuentadante = $ambiente->getCuentadante(); ?>
      <td><?php echo $cuentadante->getNombres() . " " . $cuentadante->getApellidos(); ?></td>
      <td><?php echo $ambiente->getEstado()->getNombre(); ?></td>
      <td>casa</td>
      <td align="center">
        <a href="../Ambientes/editarAmbientes.php" type="button" class="btn btn-info btn-block">Editar</a></td>
      <td align="center">
        <a href="../Ambientes/InactivarAmbientes.php" type="button" class="btn btn-danger btn-block">Inactivar</a></td>
      </td>
    </tr>
    <?php
  }
