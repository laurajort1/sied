...
<!-- tabla -->
<div class="container">
  <table class="table table-bordered table-responsive"; align="center"; style="width: 100%; border-radius: 2px #000;text-align: center; border: 0px; overflow: scroll;">
  ...
  <tr>
    ...
    <td  style="color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="nit" value="";></td>
    ...
    <!-- botones -->
    <td align="center">
      <a href="Ambientes.php" type="button" class="btn btn-info btn-block">Guardar</a></td>
    <td align="center">
      <a href="crearAmbientes.php" type="button" class="btn btn-danger btn-block">Cancelar</a></td>
    </td>
  </tr>
