...
<div class="container">
  ...
  <tr>
    ...
    <td  style=" width: 10%; color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="serial" value="123456789";></td>
  
    <!-- Placa -->
    <td bgcolor="#eaeaea" align="left" style="font-family: calibri;"><b>Placa</td>       
    <td style="width: 10%; color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="serial" value="A2D3D3";></td>
    ...
    <td bgcolor="#eaeaea" align="left" style="font-family: calibri;"><b>Nombre</td>
      ...
      <input  class="form-control" type="text" name="nombre" value="Silla";></td>
   </tr>
  <tr>
<tr>
    <!-- Descripción -->
    ...
    <td style="color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="descripcion" value="blanca de ruedas";></td>
    
    <!-- Marca -->
    <td bgcolor="#eaeaea" align="left" style="font-family: calibri; "><b>Marca</b></td>
    <td  style="color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="marca" value="rimax";></td>

   <!-- Modelo -->
    <td bgcolor="#eaeaea" align="left" style="font-family: calibri; width: 20%;"><b>Modelo</b></td>
    <td style="color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="modelo" value="AG23";></td>
  </tr>
   <tr>
    <!-- Valor -->
    <td bgcolor="#eaeaea" align="left" style="font-family: calibri; width: 20%;"><b>Valor</b></td>
    <td  style="color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="modelo" value="25.000";></td>
    
    <!-- FechaInicial -->
    <td bgcolor="#eaeaea" align="left" style="font-family: calibri; width: 20%;"><b>FechaInicial</b></td>
    <td style="color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="date" name="modelo";></td>
   ...
   <tr>
    ...
    <td align="center" style="color: #000; font-family: Calibri; font-weight: bold;">
     ...
     <td align="center">
      <a href="../Elementos/Elementos.php" type="button" class="btn btn-success btn-block">Guardar</a></td>
    <td align="center">
