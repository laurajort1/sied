...
<div>
  ...
  <tr>  
    ...
    <td bgcolor="#eaeaea" align="center" style="font-family: calibri;">
      <input  class="form-control" type="text" name="serial" value="1098724235"; disabled ></td> 
    <!-- serial -->
    <td  style=" color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="serial" value="Felipe Nickolas"; disabled ></td>
    <!-- Placa -->         
    <td  style=" color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="placa" value="fgarcia243@misena.edu.co"; disabled ></td>
    <!-- Nombre -->
    <td  style=" color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="nombre" value="3166229030"; disabled ></td>
    <!-- Descripción -->
    <td  style=" color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="nombre" value="03/06/1992"; disabled ></td>    
    <!-- Marca -->
    <td  style=" color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="nombre" value="img.png"; disabled ></td>
    <!-- Modelo -->
    <td  style=" color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="nombre" value="12345"; disabled ></td> 
    <!-- Valor -->
    <td  style=" color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="nombre" value="Activo"; disabled></td>    
    <!-- FechaInicial -->
    <td  style=" color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="nombre" value="Cuentadante"; disabled></td>
    <!-- Estado -->
    <td  style=" color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="nombre" value="Centro de Atención al sector Agropecuario"; disabled></td>  
    <!-- Ambiente -->
    <td  style=" color: #000; font-family: Calibri; font-weight: bold;">
      <input  class="form-control" type="text" name="nombre" value="Ambiente 0"; disabled></td>
     <td align="center">
